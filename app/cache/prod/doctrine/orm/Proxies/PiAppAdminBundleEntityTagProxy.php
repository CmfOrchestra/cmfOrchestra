 ...
 */
class PiAppAdminBundleEntityTagProxy extends \PiApp\AdminBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'translations', 'id', 'groupname', 'groupnameother', 'name', 'color', 'Hicolor', 'created_at', 'updated_at', 'archive_at', 'enabled');
    }
