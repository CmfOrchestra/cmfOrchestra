...
/* organigram:Rubrique~org-chart-page:ar_SA:{"menu"#"page","id"#".org-chart-page","action"#"renderByClick"} */
class __TwigTemplate_d263e3cf605ce2d8675ff8ea8d27afe8 extends Twig_Template
{
...
\t\t";
    ...
    {
        return "organigram:Rubrique~org-chart-page:ar_SA:{\"menu\"#\"page\",\"id\"#\".org-chart-page\",\"action\"#\"renderByClick\"}";
    }
