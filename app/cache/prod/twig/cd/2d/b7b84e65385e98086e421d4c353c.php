...
/* organigram:Rubrique~org-chart-page:fr:{"menu"#"page","id"#".org-chart-page","action"#"renderByClick"} */
class __TwigTemplate_cd2db7b84e65385e98086e421d4c353c extends Twig_Template
{
...
\t\t";
    ...
    {
        return "organigram:Rubrique~org-chart-page:fr:{\"menu\"#\"page\",\"id\"#\".org-chart-page\",\"action\"#\"renderByClick\"}";
    }
