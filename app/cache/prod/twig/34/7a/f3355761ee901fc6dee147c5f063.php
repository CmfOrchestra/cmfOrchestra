...
/* organigram:Rubrique~org-chart-page:en_GB:{"menu"#"page","id"#".org-chart-page","action"#"renderByClick"} */
class __TwigTemplate_347af3355761ee901fc6dee147c5f063 extends Twig_Template
{
...
\t\t";
    ...
    {
        return "organigram:Rubrique~org-chart-page:en_GB:{\"menu\"#\"page\",\"id\"#\".org-chart-page\",\"action\"#\"renderByClick\"}";
    }
