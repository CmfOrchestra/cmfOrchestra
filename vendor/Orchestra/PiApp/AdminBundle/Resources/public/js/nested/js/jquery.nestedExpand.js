...
<div id="outer">
	<div id="demo1" class="demo cat">
	            <h3><em class="n">1.</em>Category One</h3>
	            <h4 class="expand">First title here [Show/Hide]</h4>
	            <div class="collapse">
	                <p>The expandAll() plug-in requires jQuery v.1.3+.</p>
	                <p>The plug-in applies 'Expand All/Collapse All' functionality that will collapse or expand 
	                all panels with a certain class that reside within the container on which we call the plug-in.</p>
	            </div>
	            <h4 class="expand">Second title here [Show/Hide]</h4>
	            <div class="collapse">
	                <p>Example usage with all default options:</p>
	                <p class="code">$("#container").expandAll();</p>
	                <p>We can override some default options, for example:</p>
	                <p class="code">$("#container").expandAll({showMethod: "slideDown", hideMethod: "slideUp", speed: 400});</p>
	                <p>To explore all default options, see <a class="vtr" href="/scripts/jquery/expand.txt">the script</a>.</p>
	            </div>
	            <h4 class="expand">Third title here [Show/Hide]</h4>
	            <div class="collapse">
	                <p>With JavaScript turned off, the whole content is expanded, the links "Expand All"/"Collapse All" 
	                are needless and could confuse the user. That's why 
	                these elements are generated by the expandAll() plug-in.</p>
	            </div>
	</div>
</div>
...
<!--//--><![CDATA[//><!--
$(function() {
    $("#outer div.cat h4.expand").toggler();
    $("#demo1").expandAll({trigger: "h4.expand", ref: "h4.expand"});
    $("#demo2").expandAll({trigger: "h4.expand", ref: "h4.expand", oneSwitch: false});
    $("#outer div.other").expandAll({
      expTxt : "[Show]", 
      cllpsTxt : "[Hide]",
      ref : "ul.collapse",
      showMethod : "show",
