...
use PiApp\GedmoBundle\Entity\Team;
use PiApp\GedmoBundle\Form\TeamType;
use PiApp\GedmoBundle\Entity\Translation\TeamTranslation;
...
class TeamController extends abstractController
{
    ...
    public function createAction()
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_gedmo_team_show', array('id' => $entity->getId(), 'NoLayout' => $NoLayout, 'category' => $category)));
    ...
    public function updateAction($id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_gedmo_team_edit', array('id' => $id, 'NoLayout' => $NoLayout, 'category' => $category)));
        }
    ...
    /**
     * Template : Finds and displays a Team entity.
     * 
     * @Cache(maxage="86400")
     * @return \Symfony\Component\HttpFoundation\Response
     *
