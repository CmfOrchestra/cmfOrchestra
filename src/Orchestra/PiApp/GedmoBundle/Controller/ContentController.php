...
class ContentController extends abstractController
{
    ...
    public function indexAction()
    {
    	...
    	if($NoLayout && $category && !empty($category))
    		$entities 	= $em->getRepository("PiAppGedmoBundle:Content")->getAllEnableByCat($locale, $category, 'object');
    	else
    ...
    public function newAction()
    {
    	$em 	= $this->getDoctrine()->getEntityManager();
    	$entity = new Content();
        $form   = $this->createForm(new ContentType($em), $entity, array('show_legend' => false));
    ...
    public function editAction($id)
    {
        ...
        $editForm   = $this->createForm(new ContentType($em), $entity, array('show_legend' => false));
        $deleteForm = $this->createDeleteForm($id);
