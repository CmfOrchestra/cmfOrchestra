...
$GLOBALS['JQUERY']['GRID'] = array(
		'grid-simple'	 		=> 'pi_app_admin.jquery_manager.gridsimple',
...
$GLOBALS['JQUERY']['TOOL'] = array(
		...
		'wizard'				=> 'pi_app_admin.jquery_manager.wizard',
		'wizard-flowplayer'		=> 'pi_app_admin.jquery_manager.flowplayer.wizard',
...
class PiJqueryExtension extends \Twig_Extension
{
	...
	public function __construct(ContainerInterface $container)
	{
		...
		$this->locale	 	= $this->container->get('session')->getLocale();
