...
class PiAppAdminExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if(isset($config['admin'])){
        	...
        	if(isset($config['admin']['grid_theme_css']))
        		$container->setParameter('pi_app_admin.admin.grid_theme_css', 'bundles/piappadmin/css/themes/'.$config['admin']['grid_theme_css'].'/jquery-wijmo.css');
        }        
        ...
        if(isset($config['page'])){
        	...
        	if(isset($config['page']['switch_page_other_language_if_doesnt_exist']))
        		$container->setParameter('pi_app_admin.page.switch_page_other_language_if_doesnt_exist', $config['page']['switch_page_other_language_if_doesnt_exist']);
        	...
        	if(isset($config['page']['media_pixel']))
        		$container->setParameter('pi_app_admin.page.media_pixel', $config['page']['media_pixel']);
        	if(isset($config['page']['google_analytic']))
        		$container->setParameter('pi_app_admin.page.google_analytic', $config['page']['google_analytic']);
        	if(isset($config['page']['google_analytic_tracker']))
        		$container->setParameter('pi_app_admin.page.google_analytic_tracker', $config['page']['google_analytic_tracker']);
        	if(isset($config['page']['google_analytic_template']))
        		$container->setParameter('pi_app_admin.page.google_analytic_template', $config['page']['google_analytic_template']);
        	if(isset($config['page']['google_analytic_template2']))
        		$container->setParameter('pi_app_admin.page.google_analytic_template2', $config['page']['google_analytic_template2']);
        }        
