	...
	public function build(ContainerBuilder $container)
	{
		...
		try {
			...
			$heritage_role  = array(
					...
					'ROLE_SUBSCRIBER'       => array('ROLE_USER', 'ROLE_ALLOWED_TO_SWITCH'),
					'ROLE_EDITOR'      		=> array('ROLE_USER', 'ROLE_ALLOWED_TO_SWITCH'),
					'ROLE_MODERATOR'   		=> array('ROLE_EDITOR', 'ROLE_ALLOWED_TO_SWITCH'),
					'ROLE_DESIGNER'      	=> array('ROLE_USER', 'ROLE_ALLOWED_TO_SWITCH'),
			...
			//{"ROLE_USER":"ROLE_ALLOWED_TO_SWITCH","ROLE_SUBSCRIBER":"ROLE_USER","ROLE_EDITOR":"ROLE_USER","ROLE_MODERATOR":"ROLE_EDITOR","ROLE_DESIGNER":"ROLE_USER","ROLE_CONTENT_MANAGER":["ROLE_DESIGNER","ROLE_MODERATOR"],"ROLE_ADMIN":"ROLE_CONTENT_MANAGER","SONATA":["ROLE_SONATA_PAGE_ADMIN_PAGE_EDIT ","ROLE_SONATA_PAGE_ADMIN_BLOCK_EDIT"],"ROLE_SUPER_ADMIN":["ROLE_ADMIN","ROLE_ALLOWED_TO_SWITCH","ROLE_SONATA_ADMIN","SONATA"]}
			//{"HERITAGE_ROLES":{"ROLE_USER":["ROLE_ALLOWED_TO_SWITCH"],"ROLE_SUBSCRIBER":["ROLE_USER"],"ROLE_EDITOR":["ROLE_USER"],"ROLE_MODERATOR":["ROLE_EDITOR"],"ROLE_DESIGNER":["ROLE_USER"],"ROLE_CONTENT_MANAGER":["ROLE_DESIGNER","ROLE_MODERATOR"],"ROLE_ADMIN":["ROLE_CONTENT_MANAGER"],"SONATA":["ROLE_SONATA_PAGE_ADMIN_PAGE_EDIT ","ROLE_SONATA_PAGE_ADMIN_BLOCK_EDIT"],"ROLE_SUPER_ADMIN":["ROLE_ADMIN","ROLE_ALLOWED_TO_SWITCH","ROLE_SONATA_ADMIN","SONATA"]}}
		}
